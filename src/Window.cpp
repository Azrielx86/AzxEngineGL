...
void Window::EnableWindowViewport() const // NOLINT(*-make-member-function-const)
{
    glViewport(0, 0, width, height);
}

// ReSharper disable once CppMemberFunctionMayBeStatic
void Window::EnableVsync(const bool enable) // NOLINT(*-convert-member-functions-to-static)
{
